				...
				<div class="row">
					<div class="col-lg-7">
						<div class="banner_content">
							...
							<h1 class="text-uppercase">Yo soy Yerald Sinche</h1>
							<h5 class="text-uppercase">Desarrollador y Analista de Software</h5>
							<div class="d-flex align-items-center">
								<a class="primary_btn" href="#"><span>Contactame</span></a>
								<a class="primary_btn tr-bg" href="#"><span>Obten mi CV</span></a>
							</div>
						</div>
					</div>
					<div class="col-lg-5">
